...
var hBar = new ItemStyle(17, 10, '', 0, 0, '', '#858585', 'highText', 'highText', '', '',
 null, null, 'hand', 'default');

var subM = new ItemStyle(22, 0, '&gt;', -15, 3, '#C0C0C0', '#858585', 'lowText', 'highText',
 '', '', null, null, 'hand', 'default');

var subBlank = new ItemStyle(22, 1, '&gt;', -15, 3, '#C0C0C0', '#858585', 'lowText', 'highText',
 '', '', null, null, 'hand', 'default');
...
startMenu('mCalls', true, 140, 0, 110, subM);
addItem('Entering Calls', 'window.open("http://lasdn-sd01/support_web/1stlevel/HowTo/calls/index.php")' , 'js:');

startMenu('mUSGHSG', true, 140, 0, 210, subM);
addItem('Adding a User/MAC Address', 'window.open("http://lasdn-sd01/support_web/1stlevel/HowTo/USGHSG/adduser.php")' , 'js:');

startMenu('mPorts', true, 140, 0, 200, subM);
addItem('Virus and Non Virus Ports', 'window.open("http://lasdn-sd01/support_web/1stlevel/HowTo/ports/VirusPorts.php")' , 'js:');
addItem('Game Ports', 'window.open("http://lasdn-sd01/support_web/1stlevel/HowTo/ports/GamePorts.php")' , 'js:');

startMenu('mBilling', true, 140, 0, 220, subM);
addItem('Front Desk Requests a Refund', 'http://lasdn-sd01/support_web/1stlevel/HowTo/FrontDeskRequestsaRefund.php' , '');
addItem('User Requests a Refund', 'http://lasdn-sd01/support_web/1stlevel/HowTo/UserRequestsaRefund.php' , '');

startMenu('mBrowser', true, 140, 0, 200, subM);
addItem('Page Cannot Be Displayed', 'http://lasdn-sd01/support_web/1stlevel/HowTo/PageCannotBeDisplayed.php' , '');
addItem('Cannot Get to Homepage', 'http://lasdn-sd01/support_web/1stlevel/HowTo/CannotGetToHomepage.php' , '');
addItem('Clearing Cache in Safari', 'window.open("http://lasdn-sd01/support_web/1stlevel/HowTo/ClearingSafariCache.php")' , 'js:');

startMenu('mConnectivity', true, 140, 0, 280, subM);
addItem('Cannot Get IP Address', 'http://lasdn-sd01/support_web/1stlevel/HowTo/CannotGetIPAddress.php' , '');
addItem('Cannot Connect To Internet', 'http://lasdn-sd01/support_web/1stlevel/HowTo/CannotConnectToInternet.php' , '');
addItem('Has IP Address&#44 Cannot Get To Internet', 'http://lasdn-sd01/support_web/1stlevel/HowTo/HasIPAddressCannotGetToInternet.php' , '');

startMenu('mCPE', true, 140, 0, 220, subM);
addItem('Cisco 575 LRE', 'window.open("http://lasdn-sd01/support_web/1stlevel/HowTo/CPEType3.php")' , 'js:');
addItem('Cisco 585 LRE', 'window.open("http://lasdn-sd01/support_web/1stlevel/HowTo/CPEType4.php")' , 'js:');
addItem('Cygnet &#40iWay-4Points SD&#41', 'window.open("http://lasdn-sd01/support_web/1stlevel/HowTo/CPEType2.php")' , 'js:');
addItem('Gigalink SU400', 'window.open("http://lasdn-sd01/support_web/1stlevel/HowTo/CPEType1.php")' , 'js:');
addItem('Netopia Cayman Gateway 3341', 'window.open("http://lasdn-sd01/support_web/1stlevel/HowTo/CPEType5.php")' , 'js:');

startMenu('mEWireless', true, 140, 0, 180, subM);
addItem('Eleven Wireless', 'window.open("http://lasdn-sd01/support_web/1stlevel/HowTo/elevenwireless/index.php")' , 'js:');
addItem('Eleven Wireless w/configs', 'window.open("http://lasdn-sd01/support_web/1stlevel/HowTo/elevenwireless/index2.php")' , 'js:');

startMenu('mMAC', true, 140, 0, 180, subM);
addItem('MAC TCP/IP Commands', 'http://lasdn-sd01/support_web/1stlevel/HowTo/MACTCPIPCommands.php' , '');

startMenu('mSoftware', true, 140, 0, 150, subM);
addItem('Windows XP Firewall', 'http://lasdn-sd01/support_web/1stlevel/HowTo/WindowsXPFirewall.php' , '');

startMenu('mUpgrades', true, 140, 0, 310, subM);
addItem('Needs Routable Address', 'http://lasdn-sd01/support_web/1stlevel/HowTo/NeedsStaticIPAddress.php' , '');
addItem('User Wants To Change Current Internet Plan', 'http://lasdn-sd01/support_web/1stlevel/HowTo/UserWantsToChangeCurrentInternetPlan.php' , '');
addItem('VPN Setup', 'http://lasdn-sd01/support_web/1stlevel/HowTo/VPNSetup.php' , '');

startMenu('mWireless', true, 140, 0, 180, subM);
addItem('Association - XP', 'http://lasdn-sd01/support_web/1stlevel/HowTo/Wireless/WindowsXPWireless.php' , '');
addItem('Association - ME/2000', 'http://lasdn-sd01/support_web/1stlevel/HowTo/Wireless/WindowsME2kWireless.php' , '');
addItem('Association - NT', 'http://lasdn-sd01/support_web/1stlevel/HowTo/Wireless/WindowsNTWireless.php' , '');
addItem('Association - 9x', 'http://lasdn-sd01/support_web/1stlevel/HowTo/Wireless/Windows9xWireless.php' , '');
addItem('Association - Mac OS', 'http://lasdn-sd01/support_web/1stlevel/HowTo/Wireless/MacOSWireless.php' , '');

startMenu('mZyXEL', true, 140, 0, 100, subM);
addItem('Gateway', 'window.open("http://lasdn-sd01/support_web/1stlevel/HowTo/ZyXEL/gateway.htm")' , 'js:');
}
