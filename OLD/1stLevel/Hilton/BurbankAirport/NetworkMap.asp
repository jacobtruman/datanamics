...
<!--#include virtual='/support_web/Components/oddfolds.asp'-->
	...
	<BR>
	<map name='FPMap0'>
	<area coords='197,398,219,459' href='/support_web/dnping.asp?theaddr=12.127.16.68' target='_blank'>
	<area coords='245,398,266,460' href='/support_web/dnping.asp?theaddr=12.127.17.72' target='_blank'>
	<area coords='293,398,315,460' href='/support_web/dnping.asp?theaddr=12.127.17.71' target='_blank'>
	<area coords='350,343,518,360' href='/support_web/dnping.asp?theaddr=12.124.252.210' target='_blank'>
	<area coords='565,431,702,455' href='http://<%=lgn%>:<%=pswd%>@<%=gateway%>' target='_blank'>
	</map>
