...
if (level1 = "Yes") then
	...
	response.write "<a href='/support_web/1stLevel/"&loc&"/NetworkMap.asp?prop="&prop&"' target='_blank' style='color: #FF0000'>"
...
if (level2 = "Yes") then
	...
	response.write "<a href='/support_web/2ndLevel/"&loc&"/NetworkMap.asp?prop="&prop&"' target='_blank'>"
