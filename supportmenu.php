<table border="0" width="1" height='58'>
  <tr>
    <td width="172" valign="top" bgcolor="#F0F0F0">
<a NAME="TOP">
...
<?php
	$base = 100;
	$logosize = getimagesize("logos/{$dn_logo}");
	$logowidth = $logosize[0];
	$logoheight = $logosize[1];
?>

startMenu('root', true, 4, <?php echo $logoheight + $base;?>, 220, hBar);

addItem('Support', 'mSupport', 'sm:');
addItem("How To's", "mHowtos", "sm:");
addItem("Walkthroughs", "mWalk", "sm:");
addItem("Important Resources", "mImportant", "sm:");

startMenu('mSupport', true, 195, 0, 240, subM);
addItem('HSIA', '/support_web/forms/Results.php' , '');
addItem('Hotel Naming Convention', 'window.open("/support_web/1stlevel/HowTo/HotelNamingConventions.php")', 'js:');
//addItem('Hampton Inn Access Code Lookup', 'window.open("http://192.251.124.33/hsia/pages/obtain_codes.jsp")', 'js:');
addItem('Hampton Inn Access Code Lookup', 'window.open("http://hsia.hamptoninn.com/hsia/pages/obtain_codes.jsp")', 'js:');

startMenu('mHowtos', true, 195, 0, 220, subM);
addItem("1st Level How To's", "window.open('/support_web/1stlevel/HowTo/HowTo.php')" , "js:");
addItem("2nd Level How To's", "window.open('/support_web/2ndLevel/Howto/HowTo.php')" , "js:");
addItem("GADs", "mGADs", "sm:");
...
addItem('11 Wireless & Shift4', 'window.open("/support_web/1stlevel/HowTo/Shift411OS.php")', 'js:');
addItem('PrintMe', 'window.open("/support_web/1stlevel/HowTo/PrintMe.php")', 'js:');
addItem('Error Messages', '/support_web/1stlevel/HowTo/Errors.php' , '');

startMenu('mWalk', true, 195, 0, 230, subM);
addItem("Checking TCP/IP", 'window.open("/support_web/forms/Training_Documents/HTML/CheckingTCP.htm")', "js:");
addItem("CPE's and GAD's", 'window.open("/support_web/forms/Training_Documents/HTML/cpe_gad.htm")', "js:");
addItem("Mac OS X", 'window.open("/support_web/forms/Training_Documents/HTML/MAC_OSX.htm")', "js:");
addItem("Network Card Speed Mod", 'window.open("/support_web/forms/Training_Documents/HTML/NIC_speed.htm")', "js:");
addItem("SupportWeb Howto", 'window.open("/support_web/forms/Training_Documents/HTML/support_web.htm")', "js:");
addItem("Windows 2k, XP Wireless Configuration", 'window.open("/support_web/forms/Training_Documents/HTML/Win2k_with Pro_wireless.htm")', "js:");
addItem("General Screenshot Resource", 'window.open("http://screenshots.modemhelp.net/")', "js:");
addItem("VPN Troubleshooting", 'window.open("/support_web/forms/Training_Documents/troubleshooting_vpn.pdf")', "js:");

startMenu('mGADs', true, 220, 0, 160, subM);
addItem("3Com 3CRWE83096A", 'window.open("/support_web/Components/GAD/Type10.php")', "js:");
addItem("Asus WL-330", 'window.open("/support_web/Components/GAD/Type8.php")', "js:");
addItem("D-Link DWL-120", 'window.open("/support_web/Components/GAD/Type11.php")', "js:");
addItem("D-Link DWL-810", 'window.open("/support_web/Components/GAD/Type3.php")', "js:");
addItem("EnGenius NL-2611CB3", 'window.open("/support_web/Components/GAD/Type6.php")', "js:");
addItem("Linksys WET11", 'window.open("/support_web/Components/GAD/Type1.php")', "js:");
addItem("Linksys WSUB11", 'window.open("/support_web/Components/GAD/Type13.php")', "js:");
addItem("Motorolla", 'window.open("/support_web/Components/GAD/Type2.php")', "js:");
addItem("OTC ACR-201", 'window.open("/support_web/Components/GAD/Type4.php")', "js:");
addItem("Netgear ME101", 'window.open("/support_web/Components/GAD/Type5.php")', "js:");
addItem("SMC 2870W", 'window.open("/support_web/Components/GAD/Type7.php")', "js:");

startMenu('mImportant', true, 195, 0, 220, subM);
addItem("Eleven Wireless Login", 'window.open("https://secure.elevenwireless.com/ElevenOS/admin/login/login.aspx?ReturnUrl=%2fElevenOS%2fAdmin%2fdefault.aspx")', "js:");
addItem("RMA Procedures", 'window.open("Z:/Tech Docs/RMA Procedures")', "js:");
